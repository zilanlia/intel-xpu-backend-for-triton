...
ze_module_handle_t create_module(ze_context_handle_t context,
  ...
  const char *build_flags = "-vc-codegen -doubleGRF -Xfinalizer -noLocalSplit -Xfinalizer -DPASTokenReduction -Xfinalizer -SWSBDepReduction -Xfinalizer '-printregusage -enableBCR' ";
